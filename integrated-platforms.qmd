...
<div style="text-align: center">
![Git in a nutshell - [Source](https://medium.com/@jaaeehoonkim/git-tutorial-1-31d0b1db1940)](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*fQqHRi7EhD_8CzyVIy81lg.png){.image width="600px"}
</div>
...
<div style="text-align: center">
![Git Branches - [Source](https://www.nobledesktop.com/learn/git/git-branches)](https://www.nobledesktop.com/image/gitresources/git-branches-merge.png){.image width="500px"}
</div>
...
GitHub is like a social network for your code. It's where you can store your projects online, collaborate with others and share your work with the world.
...
3. **Collaborating with Others**
   ...
   git push
   ```
![Git and B-cell analogy](./images/git-bcell.png){.image width="500px"}
