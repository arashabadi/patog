...
This book is a Quarto-based online HTML book for the PATOG project. See [CONTRIBUTING.md](https://github.com/arashabadi/patog/blob/main/CONTRIBUTING.md) for more information.

<div style="text-align:center; margin: 2em 0 1em 0;">
  <a href="https://github.com/arashabadi/patog" class="btn btn-primary" style="display:inline-flex;align-items:center;gap:0.5em; font-size:1.1em; padding:0.5em 1.2em;">
