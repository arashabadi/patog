...
Checkout [PATOQ Wiki](https://github.com/arashabadi/patoq/wiki) for the Bioinformatics and Computational Biology Learning Roadmap!

![Learning Journey](./images/puzzle.png){.image width="300px"}
